...
import { trackMousePosition, setupEventDelegation } from '../main'

describe('Task 2: trackMousePosition - Mouse Position Tracker', () => {
  beforeEach(() => {
...
describe('Task 3: setupEventDelegation - Event Delegation for List Items', () => {
  beforeEach(() => {
    document.body.innerHTML = ''
    vi.clearAllMocks()
  })
